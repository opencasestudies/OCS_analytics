...
pivot_longer(users_date, c(totalUsers, newUsers, active7DayUsers), 
             names_to = "metric", values_to = "count") %>%
...
cities = ga_data(ocs_property_id,
          date_range = c("2021-01-01", "yesterday"),
          metrics = c("newUsers"),
          dimensions = c("cityId", "city"), limit = 1000)
cities
```
...
dhm = ga_data(ocs_property_id,
          date_range = c("2021-01-01", "yesterday"),
          metrics = c("sessions"),
          dimensions = c("hour","minute"), limit = 1000)
dhm
```
...
OSversion = ga_data(ocs_property_id,
          date_range = c("2021-01-01", "yesterday"),
          metrics = c("sessions"),
          dimensions = c("operatingSystemWithVersion", "operatingSystem"))
OSversion
```
