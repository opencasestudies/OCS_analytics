...
leveltaughtplot = ggplot(teach_stud_sum, aes(x = type, y = percent, fill = type)) +
  geom_col() + scale_fill_viridis_d() + 
  labs(x = "Student Type", y = "Percent (%)", 
       title = "Types of Students Taught by Educators") + 
  guides(fill = "none") + 
...
coursetaughtplot = ggplot(courses_taught_sum, aes(x = subject, y = percent, fill = subject)) +
  geom_col() + scale_fill_viridis_d() + 
  labs(x = "Course Subject", y = "Percent (%)", 
       title = "Courses Taught by Educators") + 
  guides(fill = "none") + 
  theme(axis.text.x = element_text(angle = 60, vjust = 0.5)) + 
  scale_y_continuous(labels = function(x) paste0(x, "%")) + 
