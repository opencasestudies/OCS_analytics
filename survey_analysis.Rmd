...
ggplot(consented, aes(x = forcats::fct_infreq(as.factor(responder_category)), fill = responder_category)) +
  ...
  labs(x = "User Category", y = "Count", title = "Count of Survey Responders by Category") + ylim(c(0,11)) + 
...
ggplot(teach_stud_sum, aes(x = type, y = percent, fill = type)) +
...
ggplot(teach_int_sum, aes(x = fct_reorder(as.factor(name), specific), y = percent, 
                          fill = topic)) +
  geom_col() + scale_fill_viridis_d() + 
  labs(x = "Subject", y = "Percent of Responders", title = "Educator Teaching Interests") + 
...
ggplot(courses_taught_sum, aes(x = subject, y = percent, fill = subject)) +
  geom_col() + scale_fill_viridis_d() + 
...
ggplot(looked_at_cs_counts, aes(x = case_study, y = percent, fill = responder_category)) +
  ...
  labs(x = "Case Study", y = "Percent", 
       title = "Percent of Case Studies Looked at By Responders") + 
  theme(axis.text.x = element_text(angle = 60, vjust = 0.5)) + 
...
ggplot(parts_interest_sum, aes(x = parts, y = percent, fill = parts)) +
  geom_col() + scale_fill_viridis_d() + 
  labs(x = "Material", y = "Percent", 
...
ggplot(sect_interest_sum, aes(x = sections, y = percent, fill = sections)) +
  geom_col() + scale_fill_viridis_d() + 
  labs(x = "Section", y = "Percent", 
...
ggplot(referdf, aes(x = as.factor(refer_back), y = percent, fill = as.factor(refer_back))) +
  geom_col() + scale_fill_viridis_d() + 
  labs(x = "Rank (out of 5)", y = "Percent", 
...
ggplot(famildf1, aes(x = response, y = percent, fill = topic)) +
  geom_bar(position = "dodge", stat = "identity") + scale_fill_viridis_d() + 
...
```{r, familiarity2}
ggplot(famildf2, aes(x = response, y = percent, fill = topic)) +
  geom_bar(position = "dodge", stat = "identity") + scale_fill_viridis_d() + 
  labs(x = "Rank (out of 5)", y = "Percent of Responses", 
...
ggplot(learn_newdf, aes(x = as_factor(topics), y = percent, fill = as_factor(topics))) +
  geom_col() + scale_fill_viridis_d() + 
  labs(x = "Topic", y = "Percent of Responders", 
...
howfound %>% count(how_found, name = "num_students") %>% 
  mutate(percent = 100*num_students/num_responses)
```
