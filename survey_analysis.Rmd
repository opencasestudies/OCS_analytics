...
educatordf %<>%
  mutate(
    ...
    teach_spfc_stats = case_when(
      ...
      TRUE ~ 0),
    teach_ds = case_when(
      (grepl('"data science"', teaching_interests) == TRUE) && 
        (length(teaching_interests) > 1)  ~ 1,
      (grepl("data science", teaching_interests) == TRUE) && 
        (length(teaching_interests) = 1)  ~ 1,
      TRUE ~ 0),
    ...
    teach_tidyverse = case_when(
      ...
      TRUE ~ 0),
    teach_PH = case_when(
      (grepl('"public health"', teaching_interests) == TRUE) && 
        (length(teaching_interests) > 1)  ~ 1,
      (grepl("public health", teaching_interests) == TRUE) && 
        (length(teaching_interests) = 1)  ~ 1,
      TRUE ~ 0),
...
studentdf %<>%
  mutate(
    ...
    learn_spfc_stats = case_when(
      ...
      TRUE ~ 0),
    learn_ds = case_when(
      (grepl('"data science"', learning_interests) == TRUE) && 
        (length(learning_interests) > 1)  ~ 1,
      (grepl("data science", learning_interests) == TRUE) && 
        (length(learning_interests) = 1)  ~ 1,
      TRUE ~ 0),
    ...
    learn_tidyverse = case_when(
      ...
      TRUE ~ 0),
    learn_PH = case_when(
      (grepl('"public health"', learning_interests) == TRUE) && 
        (length(learning_interests) > 1)  ~ 1,
      (grepl("public health", learning_interests) == TRUE) && 
        (length(learning_interests) = 1)  ~ 1,
      TRUE ~ 0),
