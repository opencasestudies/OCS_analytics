...
# almost working but slight problem:
# responses with "specific public health topic" will show TRUE in both the 
# teach_PH and teach_spfc_PH columns, even if the respondent did not have 
# "public health" in general as an answer
# same issue will occur with teach_ds and teach_spfc_ds
  ...
  mutate(
    ...
    teach_spfc_PH = case_when(
      ...
      TRUE ~ 0)
                 ...
                 teach_R, teach_tidyverse, teach_PH, teach_spfc_PH, .after = teaching_interests)
...
# educatordf %>%
#   separate(type_student_taught, into = c("teach_grad","teach_ugrad", "teach_HS"), sep = ",")
